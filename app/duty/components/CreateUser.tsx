        ...
        <form onSubmit={handleSubmit(onSubmit)} className="flex flex-col items-center justify-center gap-6 w-full md:w-11/12">
            ...
            <section className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 w-full items-center justify-items-center">
                <span className="flex flex-col w-full">
                    <input {...register("name")} placeholder="Enter Name" className="bg-white dark:bg-gray-950/40 border border-purple-300 px-4 py-2 rounded-2xl w-full" />
                    {errors.name && <p className="text-pink-700 text-sm">{errors.name.message}</p>}
                </span>

                <span className="flex flex-col w-full">
                    <input {...register("email")} placeholder="Enter Email" className="bg-white dark:bg-gray-950/40 border border-purple-300 px-4 py-2 rounded-2xl w-full" />
                    {errors.email && <p className="text-pink-700 text-sm">{errors.email.message}</p>}
                </span>

                <span className="flex flex-col w-full">
                    <input {...register("phone")} type="tel" placeholder="Enter Phone number" className="bg-white dark:bg-gray-950/40 border border-purple-300 px-4 py-2 rounded-2xl w-full" />
                    {errors.phone && <p className="text-pink-700 text-sm">{errors.phone.message}</p>}
                </span>

                <span className="flex flex-col w-full">
                    <input {...register("nid")} placeholder="Enter NID number" className="bg-white dark:bg-gray-950/40 border border-purple-300 px-4 py-2 rounded-2xl w-full" />
                    {errors.nid && <p className="text-pink-700 text-sm">{errors.nid.message}</p>}
                </span>

                <span className="flex flex-col w-full">
                    <input {...register("password")} type="password" placeholder="Enter password" className="bg-white dark:bg-gray-950/40 border border-purple-300 px-4 py-2 rounded-2xl w-full" />
                    {errors.password && <p className="text-pink-700 text-sm">{errors.password.message}</p>}
                </span>

                <span className="flex flex-col w-full">
                    <input {...register("confirmPassword")} type="password" placeholder="Retype password" className="bg-white dark:bg-gray-950/40 border border-purple-300 px-4 py-2 rounded-2xl w-full" />
                        ...
                        return (
                            <>
                                <Select
                                    ...
                                    className="w-3/4 text-black bg-white dark:bg-gray-950/40 rounded-[1rem]"
                                    styles={customStyles}
